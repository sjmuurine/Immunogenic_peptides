...
echo "=================================================="
echo "CD-HIT Epitope Clustering (20 species - B_longum_suis merged)"
echo "=================================================="
...
def parse_species_from_protein_id(protein_id):
    ...
    species_patterns = {
        ...
        'fragilis': 'B_fragilis',
        'longum': 'B_longum',  # Will handle both B_longum and B_longum_suis
    ...
    if og_idx and og_idx > 0:
        ...
        # Merge B_longum_suis into B_longum
...
print("\nProcessing clusters and parsing species (20 SPECIES - B_longum_suis merged)...")
species_found = set()
...
for cluster_id, members in clusters.items():
    ...
    # Parse species (CORRECTED - merges B_longum_suis)
    species_set = set()
