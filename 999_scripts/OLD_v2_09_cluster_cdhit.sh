...
echo "=================================================="
echo "CD-HIT Epitope Clustering"
echo "=================================================="
...
# CD-HIT parameters:
# -c 0.8 = 80% identity threshold
# -n 4 = word size (4 for ~80% identity)
...
with open(cluster_file, 'r') as f:
    for line in f:
        ...
        if line.startswith('>Cluster'):
            ...
            # Format: "0	15aa, >12345... *" or "1	15aa, >67890... at 85%"
...
for _, row in cluster_df.head(10).iterrows():
    print(f"  {row['Representative_Sequence'][:40]:40} - {row['Num_Species']} species")
